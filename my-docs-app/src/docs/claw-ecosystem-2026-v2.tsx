...
export default function ClawEcosystem2026V2() {
      ...
      <main className="main">
        <div className="content">
          ...
          <div className="flow-box">
            <span className="a">You</span>{"  →  "}<span className="b">Channel</span>{" (Telegram / WhatsApp)  →  "}<span className="c">Gateway</span>{"  →  "}<span className="a">Agent Brain</span>{"  →  "}<span className="b">{"Tools & Skills"}</span>{"\n                                                                          ↕\n                                                                   "}<span className="c">Memory System</span>
          </div>
